...
class RoofPostProcessor:
    ...
    def post_process(self, raw_results: List[DetectionResult]) -> PostProcessedResults:
        ...
        # Accept all roof-plane class names: legacy roof_plane/roof_area, YOLO slope_*, SAM slope_*
        _ROOF_CLASSES = ("roof_plane", "roof_area",
                         "slope_flat", "slope_min", "slope_poly", "slope_trap", "slope_tri")
        plane_results = [r for r in raw_results if r.class_name in _ROOF_CLASSES]
