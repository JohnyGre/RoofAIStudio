...
class ToolBar(QToolBar):
    ...
    def _create_tools(self) -> None:
        ...
        # Fetch by Address
        fetch_button = QToolButton(self)
        fetch_button.setText("Fetch")
        fetch_button.setToolTip("Fetch Satellite Image by Address")
        fetch_button.clicked.connect(self.fetch_triggered)
        self.addWidget(fetch_button)
