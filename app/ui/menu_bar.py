...
class MenuBar(QMenuBar):
    ...
    fetch_address_triggered = Signal()  # Fetch satellite by address
    ...
    def _create_ai_menu(self) -> None:
        ...
        fetch_action = self._ai_menu.addAction("Fetch by Address...")
        fetch_action.triggered.connect(self.fetch_address_triggered)
