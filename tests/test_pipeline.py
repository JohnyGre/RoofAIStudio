...
class TestFullPipeline:
    ...
    def test_full_ai_to_pricing_pipeline(
        ...
        topology_engine = RoofTopologyEngine()
        measurement_service = RoofMeasurementService()
        
        # Build topology from the geometry
        roof_topology = topology_engine.build(predicted_roof_geometry)

        # Calculate measurements using both geometry and topology
